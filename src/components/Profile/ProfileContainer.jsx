...
import {getStatus, updatePhoto, updateStatus, toggleEditMode} from '../../redux/profile_reducer';
...
export default compose(
    connect(mapStateToProps, {setProfileUser, getStatus, updateStatus, updatePhoto, toggleEditMode}),
    withRouter,
    withAuthRedirect
)(ProfileContainer);
